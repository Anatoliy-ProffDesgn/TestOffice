...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        Form.resize(1173, 805)
        icon = QtGui.QIcon.fromTheme("E:\\TestOffice\\viyar\\images\\ico.png")
        Form.setWindowIcon(icon)
        self.gridLayoutWidget = QtWidgets.QWidget(Form)
        self.gridLayoutWidget.setGeometry(QtCore.QRect(0, 0, 1171, 801))
        ...
        self.pushButton_Past = QtWidgets.QPushButton(self.gridLayoutWidget)
        self.pushButton_Past.setObjectName("pushButton_Past")
        self.verticalLayout_2.addWidget(self.pushButton_Past)
        self.treeView_3 = QtWidgets.QTreeView(self.gridLayoutWidget)
        self.treeView_3.setEditTriggers(QtWidgets.QAbstractItemView.AllEditTriggers)
        self.treeView_3.setTabKeyNavigation(False)
        self.treeView_3.setDragEnabled(True)
        self.treeView_3.setDragDropOverwriteMode(True)
        self.treeView_3.setDragDropMode(QtWidgets.QAbstractItemView.DragDrop)
        self.treeView_3.setDefaultDropAction(QtCore.Qt.TargetMoveAction)
        self.treeView_3.setAlternatingRowColors(True)
        self.treeView_3.setSelectionMode(QtWidgets.QAbstractItemView.MultiSelection)
        self.treeView_3.setSortingEnabled(False)
        self.treeView_3.setAllColumnsShowFocus(True)
    ...
    def retranslateUi(self, Form):
        ...
        self.pushButton_Past.setText(_translate("Form", "Завантажити таблицю примірник"))
